...
local task = {
    ...
    shouldExecute = function()
        ...
        return is_in_boss_zone and altar ~= nil
    end,
    ...
    Execute = function()
        ...
        -- CHECK TIMER: Ensure we wait the Post-Chest Delay set in GUI
        ...
        if tracker.chest_opened_time ~= nil and current_os_time < tracker.chest_opened_time + wait_time then 
            ...
            console.print("Waiting for Post-Chest Delay... " .. remaining .. "s remaining.")
            return 
        end
